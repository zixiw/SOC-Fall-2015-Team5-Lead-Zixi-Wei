...
// @LINE:71
private[this] lazy val controllers_AWrokflowController_addWorkflow46_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("workflow/add"))))
private[this] lazy val controllers_AWrokflowController_addWorkflow46_invoker = createInvoker(
...
// @LINE:72
private[this] lazy val controllers_AWrokflowController_getWorkflow47_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("workflow/get/"),DynamicPart("name", """[^/]+""",true))))
private[this] lazy val controllers_AWrokflowController_getWorkflow47_invoker = createInvoker(
...
// @LINE:71
case controllers_AWrokflowController_addWorkflow46_route(params) => {
   call { 
        controllers_AWrokflowController_addWorkflow46_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.AWrokflowController]).addWorkflow)
   }
}
        

// @LINE:72
case controllers_AWrokflowController_getWorkflow47_route(params) => {
   call(params.fromPath[String]("name", None)) { (name) =>
        controllers_AWrokflowController_getWorkflow47_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.AWrokflowController]).getWorkflow(name))
   }
}
